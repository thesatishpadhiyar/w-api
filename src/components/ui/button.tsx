  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-brand text-primary-foreground shadow-lg hover:shadow-glow hover:scale-[1.02] font-semibold",
        brand: "bg-primary text-primary-foreground shadow-glow hover:shadow-xl hover:bg-primary/90 font-semibold",
        "brand-outline": "border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-semibold",
        success: "bg-status-active text-primary-foreground shadow-md hover:shadow-lg hover:opacity-90",
        warning: "bg-status-pending text-primary-foreground shadow-md hover:shadow-lg hover:opacity-90",
